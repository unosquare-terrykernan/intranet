<?php
/**
 * standard functions and definitions.
 *
...
function standard_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'standard' ),
		'secondary' => esc_html__( 'Secondary Menu', 'standard' ),		
		'footer' => esc_html__( 'Footer Menu', 'standard' ),		
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'standard_custom_background_args', array(
...
function standard_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'standard_content_width', 760 );
}
 ...
 */
function standard_sidebar_init() {

	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'standard' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'standard' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 1', 'standard' ),
		'id'            => 'footer-1',
		'description'   => esc_html__( 'Add widgets here.', 'standard' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 2', 'standard' ),
		'id'            => 'footer-2',
		'description'   => esc_html__( 'Add widgets here.', 'standard' ),
		'before_widget' => '<div id="%1$s" class="widget footer-widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 3', 'standard' ),
		'id'            => 'footer-3',
		'description'   => esc_html__( 'Add widgets here.', 'standard' ),
		'before_widget' => '<div id="%1$s" class="widget footer-widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 4', 'standard' ),
		'id'            => 'footer-4',
		'description'   => esc_html__( 'Add widgets here.', 'standard' ),
		'before_widget' => '<div id="%1$s" class="widget footer-widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Header Ad', 'standard' ),
		'id'            => 'header-ad',
		'description'   => esc_html__( 'Drag the "Advertisement" widget here.', 'standard' ),
...
add_action( 'widgets_init', 'standard_sidebar_init' );
...
function standard_scripts() {
    ...
    // Enqueues CSS styles
    wp_enqueue_style( 'standard-style', get_stylesheet_uri(), array(), '20171020' );     
...
/* Admin CSS Style */
function standard_admin_style() {
	wp_enqueue_style('admin-styles', get_template_directory_uri().'/assets/css/admin.css');
}
add_action('admin_enqueue_scripts', 'standard_admin_style');
...
function standard_widgets_init() {
	...
	register_widget( 'standard_Ad_Widget' );												
