 ...
 * @since      1.0.0
 */
class Standard_Ad_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( 'Display any kinds of advertisements.', 'standard' ),
		...
		parent::__construct(
			...
			esc_html__( '&raquo; Advertisement', 'standard' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_code' ); ?>">
				<?php esc_html_e( 'Ad Code', 'standard' ); ?>
			</label>
