...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'standard' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'standard' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'standard' ),
		'cyrillic'     => __( 'Cyrillic', 'standard' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'standard' ),
		'devanagari'   => __( 'Devanagari', 'standard' ),
		'greek'        => __( 'Greek', 'standard' ),
		'greek-ext'    => __( 'Greek Extended', 'standard' ),
		'khmer'        => __( 'Khmer', 'standard' ),
		'latin'        => __( 'Latin', 'standard' ),
		'latin-ext'    => __( 'Latin Extended', 'standard' ),
		'vietnamese'   => __( 'Vietnamese', 'standard' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'standard' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'standard' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'standard' ),
