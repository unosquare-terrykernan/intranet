...
function customizer_library_demo_options() {
	...
	$sections[] = array(
		'id' => $section,
		'title' => __( 'Theme Settings', 'standard' ),
		'priority' => '10'
	);
	...
	$options['header-search-on'] = array(
		'id' => 'header-search-on',
		'label'   => __( 'Display header search form', 'standard' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 1,
	);	
	...
	$options['featured-content-on'] = array(
		...
		'label'   => __( 'Display featured content on homepage', 'standard' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 1,
	);
	...
	$options['entry-excerpt-length'] = array(
		...
		'label'   => __( 'Number of words to show on excerpt', 'standard' ),
		'section' => $section,
		'type'    => 'text',
		'default' => '30',		
	);
	...
	$options['single-featured-on'] = array(
		...
		'label'   => __( 'Display featured image on single posts', 'standard' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => true,
	);	
	...
	$options['footer-widgets-on'] = array(
		...
		'label'   => __( 'Display footer widgets', 'standard' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 1,
	);
	...
	//	'id' => 'example-range',
	//	'label'   => __( 'Example Range Input', 'standard' ),
	//	'section' => $section,
	//	'type'    => 'range',
	//	'input_attrs' => array(
	//      'min'   => 0,
