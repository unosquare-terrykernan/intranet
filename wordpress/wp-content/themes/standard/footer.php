	...
	<footer id="colophon" class="site-footer container">
		...
		<div id="site-bottom" class="clear">
			...
			<div class="site-info">
				...
				&copy; <?php echo date("o"); ?> <a href="<?php echo home_url(); ?>"><?php echo get_bloginfo('name'); ?></a> - <?php echo __('Theme by', 'standard'); ?> <a href="<?php echo $author_uri; ?>" target="_blank">HappyThemes</a>
